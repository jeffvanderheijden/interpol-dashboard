    ...
    return (
        <div 
            ...
            style={{
                ...
                left: left,
                top: top,
                width: window.name === "CodeEditor" ? "600px" : window.name === "LeaderBoard" ? "800px" : "400px",
                height: window.name === "CodeEditor" ? "500px" : window.name === "ServerList" ? "450px" : window.name === "CreateTeam" ? "612px" : window.name === "LeaderBoard" ? "800px" : "400px"
            }}
        >
