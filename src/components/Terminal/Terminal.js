...
import { setIsIllegal, setVirus } from "../../state/illegalActivity";
import "./Terminal.css";
            ...
            { !isConnected ? (
                ...
                <Terminal
                    ...
                    commands={{
                        ...
                        'node': (arg) => { if(fileVisible && arg[1] === "run" && arg[2] === "definitely_not_a_virus.txt") { dispatch(setVirus(true)); return "\n\n\n\n\n\n-------WARNING-------\nVirus detected... \nSystem compromised...\n---------------------" } else { return "Invalid command." } }
                    }}
